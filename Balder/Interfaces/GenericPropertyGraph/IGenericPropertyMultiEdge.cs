...
namespace eu.Vanaheimr.Balder
{
    ...
    /// <typeparam name="TKeyHyperEdge">The type of the hyperedge property keys.</typeparam>
    /// <typeparam name="TValueHyperEdge">The type of the hyperedge property values.</typeparam>
    /// <param name="Graph">The associated generic property graph.</param>
    /// <param name="EdgeSelector">A delegate for deciding if an edge matches a multiedge.</param>
    /// <param name="Id">The Id of this multiedge.</param>
    /// <param name="Label">The label of this multiedge.</param>
    /// <param name="MultiEdgeInitializer">A delegate to initialize this multiedge with custom data.</param>
    /// <param name="Edges">An enumeration of edges to be connected by the multiedge.</param>
    ...
    #region MultiEdgeCollectionInitializer
    ...
    /// <typeparam name="TKeyHyperEdge">The type of the hyperedge property keys.</typeparam>
    /// <typeparam name="TValueHyperEdge">The type of the hyperedge property values.</typeparam>
    public delegate IGroupedCollection<TIdMultiEdge, IReadOnlyGenericPropertyMultiEdge<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                                                       TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                                       TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
...

    {
        ...
        /// </summary>
        IVotingSender<IReadOnlyGenericPropertyMultiEdge<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                              TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                              TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                              TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>,
        ...
        /// <summary>
        /// Add the given edge to the multiedge, and returns it again.
        /// An exception will be thrown if the edge identifier is already being
        /// used by the multiedge to reference another edge.
        /// </summary>
        /// <param name="Edge">An edge.</param>
        /// <param name="CheckExistanceDelegate">A delegate the check the existance of the given edge within the given multiedge.</param>
