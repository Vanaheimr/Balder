...
namespace org.GraphDefined.Vanaheimr.Balder
{
    ...
    /// <summary>
    /// A delegate for doing something with a read-only generic property vertex.
    /// </summary>
    ...
    public delegate void VertexAction<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
    ...
    #region CheckVertexExistanceInGraph

    /// <summary>
    /// A delegate to check the existance of a vertex within the given property graph.
    /// </summary>
    /// <typeparam name="TIdVertex">The type of the vertex identifiers.</typeparam>
    /// <typeparam name="TRevIdVertex">The type of the vertex revision identifiers.</typeparam>
    /// <typeparam name="TVertexLabel">The type of the vertex type.</typeparam>
    ...
    /// <param name="Vertex">A read-only generic property vertex.</param>
    public delegate Boolean CheckVertexExistanceInGraph<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                        TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                        TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                        TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>(
    ...
    public static partial class Extentions
    {
        ...
        #region FailSafeInvoke<T>(this VertexAction, Vertex, Action = null)
        ...
        /// <typeparam name="TKeyHyperEdge">The type of the hyperedge property keys.</typeparam>
        /// <typeparam name="TValueHyperEdge">The type of the hyperedge property values.</typeparam>
        /// <param name="VertexAction">A vertex delegate.</param>
        /// <param name="Vertex">The parameter of the delegate.</param>
        /// <param name="Action">A second delegate if the vertex delegate is undefined.</param>
        public static void FailSafeInvoke<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                          TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                          TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                          TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>

                               (this VertexAction<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                  TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                  TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                  TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge> VertexAction,
                                ...
                                VertexAction<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                             TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                             TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                             TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge> Action = null)
...

        {
            ...
            // ThreadLocal copies of the delegates...
            var VertexActionCopy  = VertexAction;
            var ActionCopy        = Action;

            if (VertexActionCopy != null)
                VertexActionCopy(Vertex);
            else
                if (ActionCopy != null)
                    ActionCopy(Vertex);
        ...
        #region FailSafeInvoke<T>(this VertexFilter, Vertex, DefaultValue = true)
        ...
        /// <typeparam name="TKeyHyperEdge">The type of the hyperedge property keys.</typeparam>
        /// <typeparam name="TValueHyperEdge">The type of the hyperedge property values.</typeparam>
        /// <param name="EdgeFilter">A edge filter delegate.</param>
        /// <param name="Edge">The parameter of the delegate.</param>
        /// <param name="DefaultValue">The default value, when the filter delegate is null.</param>
        public static Boolean FailSafeInvoke<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                             TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                             TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                             TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>

                                  (this VertexFilter<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                     TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                     TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
...

        {
            ...
            // ThreadLocal copy of the delegate...
            var VertexFilterCopy = VertexFilter;

            if (VertexFilterCopy != null)
                return VertexFilterCopy(Vertex);
    ...
    #region IReadOnlyGenericPropertyVertex<...>
