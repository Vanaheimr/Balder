...
namespace org.GraphDefined.Vanaheimr.Balder
{
    ...
    public static class IGenericPropertyHyperEdgeExtensions
    {
        ...
        #region SetPropertyIf(this HyperEdge, Key, Value, Predicate)

        /// <summary>
        /// Set a property on a generic property hyperedge and return this
        /// hyperedge if the given predicate is true, else return null.
        /// </summary>
        /// <param name="Edge">A generic property hyperedge.</param>
        /// <param name="Key">The key of the hyperedge property.</param>
        /// <param name="Value">The value of the property.</param>
        /// <param name="Predicate">A condition to match before the property is set.</param>
        /// <returns>The changed generic property hyperedge.</returns>
        public static IGenericPropertyHyperEdge<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>
...

        {
            ...
            if (Predicate(HyperEdge, Key, Value))
                HyperEdge.Set(Key, Value);
