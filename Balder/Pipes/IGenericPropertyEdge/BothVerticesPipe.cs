...
namespace org.GraphDefined.Vanaheimr.Balder
{
    ...
    public static class BothVerticesPipeExtensions
    {
        ...
        public static BothVerticesPipe<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
        ...
        #region BothV(this IReadOnlyGenericPropertyEdge<...>, VertexFilter)
        ...
        #region BothV(this IEnumerable<IReadOnlyGenericPropertyEdge<...>>, VertexFilter)
    ...
    /// <summary>
    /// Emits the outgoing/tail/source and incoming/head/target vertices
    /// of the given generic property edges.
    /// </summary>
    /// <typeparam name="TIdVertex">The type of the vertex identifiers.</typeparam>
    /// <typeparam name="TRevIdVertex">The type of the vertex revision identifiers.</typeparam>
    /// <typeparam name="TVertexLabel">The type of the vertex type.</typeparam>
...

    {
        ...
        #region BothVerticesPipe(IEnumerable = null, IEnumerator = null, params VertexLabels)

        /// <summary>
        /// Emits the outgoing/tail/source and incoming/head/target vertices of the given
        /// generic property edges having the given vertex labels (OR-logic).
        /// </summary>
        ...
        /// <param name="VertexLabels">An optional array of vertex labels to traverse (OR-logic).</param>
        public BothVerticesPipe(IEnumerable<IReadOnlyGenericPropertyEdge<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                                         TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                         TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
        ...
        #region BothVerticesPipe(VertexFilter, IEnumerable = null, IEnumerator = null)

        /// <summary>
        /// Emits the outgoing/tail/source and incoming/head/target vertices of the given
        /// generic property edges filtered by the given vertex filter.
        /// </summary>
        /// <param name="VertexFilter">An optional delegate for vertex filtering.</param>
        /// <param name="IEnumerable">An optional IEnumerable&lt;...&gt; as element source.</param>
        /// <param name="IEnumerator">An optional IEnumerator&lt;...&gt; as element source.</param>
        public BothVerticesPipe(VertexFilter<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                             TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                             TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                             TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge> VertexFilter,
            ...
            : base(TraversalDirection.Both, VertexFilter, IEnumerable, IEnumerator)
