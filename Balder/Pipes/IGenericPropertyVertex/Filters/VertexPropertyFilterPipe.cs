...
namespace eu.Vanaheimr.Balder
{
    ...
    #region VertexPropertyFilterPipeExtensions

    /// <summary>
    /// Extension methods for the VertexPropertyFilterPipe.
    /// </summary>
    public static class VertexPropertyFilterPipeExtensions
    {

        #region PFilter(this SourcePipe<IReadOnlyGenericPropertyVertex<...>>, Key, ComparisonFilter)

        /// <summary>
        /// Filter the given enumeration of read-only generic property
        /// vertices by their properties.
        /// </summary>
        ...
        public static VertexPropertyFilterPipe<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                               ...
                                               PFilter<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                   ...
                                                   TKeyVertex                     Key,
                                                   ComparisonFilter<TValueVertex> ComparisonFilter)
...

        {
            ...
            return new VertexPropertyFilterPipe<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
    ...
    #region VertexPropertyFilterPipe<...>
    ...
    public class VertexPropertyFilterPipe<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                    ...
                    : APropertyFilterPipe<TKeyVertex, TValueVertex, IReadOnlyGenericPropertyVertex<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                                                                   TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                                                   TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                                                                   TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>>
...

    {
        ...
        public VertexPropertyFilterPipe(IEndPipe<IReadOnlyGenericPropertyVertex<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                                                TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                                TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                                                TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>> SourcePipe,
                                        TKeyVertex                     Key,
    ...
    #region VertexPropertyFilterPipe<...TCast>
