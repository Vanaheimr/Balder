...
namespace org.GraphDefined.Vanaheimr.Balder
{
    ...
    public static class BothEdgesPipeExtensions
    {
        ...
        #region BothE(this IEnumerable<IReadOnlyGenericPropertyVertex<...>>, params EdgeLabels)   // BothE()!

        /// <summary>
        /// Emits the incoming and outgoing edges of the enumerated generic property vertices
        ...
        /// <returns>The incoming and outgoing edges of the enumerated generic property vertices.</returns>
        ...
        #region BothE(this IEnumerable<IReadOnlyGenericPropertyVertex<...>>, IncludeEdges)
        ...
        /// <summary>
        /// Emits the incoming and outgoing edges of the given generic property vertex
        /// having one of the given edge labels (OR-logic).
        /// </summary>
        /// <typeparam name="TIdVertex">The type of the vertex identifiers.</typeparam>
        /// <typeparam name="TRevIdVertex">The type of the vertex revision identifiers.</typeparam>
        ...
        /// <returns>A pipe emitting the incoming and outgoing edges of the given generic property vertex.</returns>
        ...
        #region BothE(this IReadOnlyGenericPropertyVertex<...>, IncludeEdges)
        ...
        #region BothE(this IEndPipe<IReadOnlyGenericPropertyVertex<...>>, params EdgeLabels)

        /// <summary>
        /// Emits the incoming and outgoing edges of the received generic property vertices
        /// having one of the given edge labels (OR-logic).
        /// </summary>
        /// <typeparam name="TIdVertex">The type of the vertex identifiers.</typeparam>
        /// <typeparam name="TRevIdVertex">The type of the vertex revision identifiers.</typeparam>
        ...
        /// <param name="EdgeLabels">An optional array of edge labels to traverse (OR-logic).</param>
        /// <returns>A pipe emitting the incoming and outgoing edges of the received generic property vertices.</returns>
        public static IEndPipe<IReadOnlyGenericPropertyEdge<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                            TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                            TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                            TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>>
        ...
        #region BothE(this IEndPipe<IReadOnlyGenericPropertyVertex<...>>, IncludeEdges)
    ...
    /// <summary>
    /// A pipe emitting the incoming and outgoing edges of the received generic property vertices.
    /// </summary>
    /// <typeparam name="TIdVertex">The type of the vertex identifiers.</typeparam>
    /// <typeparam name="TRevIdVertex">The type of the vertex revision identifiers.</typeparam>
    /// <typeparam name="TVertexLabel">The type of the vertex type.</typeparam>
...

    {
        ...
        #region BothEdgesPipe(Vertices, params EdgeLabels)

        /// <summary>
        /// Creates a pipe emitting the incoming and outgoing edges of the received generic property vertices
        /// having one of the given edge labels (OR-logic).
        /// </summary>
        /// <param name="Vertices">The vertices to traverse.</param>
        /// <param name="EdgeLabels">An optional array of edge labels to traverse (OR-logic).</param>
        public BothEdgesPipe(IEndPipe<IReadOnlyGenericPropertyVertex<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                                     TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                     TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                                     TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>> Vertices,
        ...
        #region BothEdgesPipe(Vertices, IncludeEdges)
        ...
        public BothEdgesPipe(IEndPipe<IReadOnlyGenericPropertyVertex<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
            ...
            : base(Vertices, TraversalDirection.Both, EdgeFilter)
