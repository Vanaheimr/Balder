...
namespace org.GraphDefined.Vanaheimr.Balder
{
    ...
    public static class InEdgesPipeExtensions
    {
        ...
        #region InE(this IEnumerable<IReadOnlyGenericPropertyVertex<...>>, params EdgeLabels)   // InE()!

        /// <summary>
        /// Emits the incoming edges of the enumerated generic property vertices
        ...
        /// <returns>The incoming edges of the enumerated generic property vertices.</returns>
        ...
        #region InE(this IEnumerable<IReadOnlyGenericPropertyVertex<...>>, IncludeEdges)
        ...
        /// <summary>
        /// Emits the incoming edges of the given generic property vertex
        /// having one of the given edge labels (OR-logic).
        /// </summary>
        /// <typeparam name="TIdVertex">The type of the vertex identifiers.</typeparam>
        /// <typeparam name="TRevIdVertex">The type of the vertex revision identifiers.</typeparam>
        ...
        /// <returns>A pipe emitting the incoming edges of the given generic property vertex.</returns>
        ...
        #region InE(this IReadOnlyGenericPropertyVertex<...>, IncludeEdges)
        ...
        #region InE(this IEndPipe<IReadOnlyGenericPropertyVertex<...>>, params EdgeLabels)

        /// <summary>
        /// Emits the incoming edges of the received generic property vertices
        /// having one of the given edge labels (OR-logic).
        /// </summary>
        /// <typeparam name="TIdVertex">The type of the vertex identifiers.</typeparam>
        /// <typeparam name="TRevIdVertex">The type of the vertex revision identifiers.</typeparam>
        ...
        /// <param name="EdgeLabels">An optional array of edge labels to traverse (OR-logic).</param>
        /// <returns>A pipe emitting the incoming edges of the received generic property vertices.</returns>
        public static IEndPipe<IReadOnlyGenericPropertyEdge<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                            TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                            TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                            TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>>
        ...
        #region InE(this IEndPipe<IReadOnlyGenericPropertyVertex<...>>, IncludeEdges)
    ...
    /// <summary>
    /// A pipe emitting the incoming edges of the received generic property vertices.
    /// </summary>
    /// <typeparam name="TIdVertex">The type of the vertex identifiers.</typeparam>
    /// <typeparam name="TRevIdVertex">The type of the vertex revision identifiers.</typeparam>
    /// <typeparam name="TVertexLabel">The type of the vertex type.</typeparam>
...

    {
        ...
        #region InEdgesPipe(Vertices, params EdgeLabels)

        /// <summary>
        /// Creates a pipe emitting the incoming edges of the received generic property vertices
        /// having one of the given edge labels (OR-logic).
        /// </summary>
        /// <param name="Vertices">The vertices to traverse.</param>
        /// <param name="EdgeLabels">An optional array of edge labels to traverse (OR-logic).</param>
        public InEdgesPipe(IEndPipe<IReadOnlyGenericPropertyVertex<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                                   TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                   TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                                   TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>> Vertices,
        ...
        #region InEdgesPipe(Vertices, IncludeEdges)
