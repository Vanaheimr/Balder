...
namespace de.ahzf.Blueprints.PropertyGraph.InMemory
{
...

    {
        ...
        public Int32 CompareTo(IReadOnlyGraphElement<TIdEdge, TRevisionIdEdge, TKeyEdge, TValueEdge> IReadOnlyGraphElement)
        {
        ...
        /// <param name="IReadOnlyGraphElement">An object to compare with.</param>
        /// <returns>True if both match; False otherwise.</returns>
        public Boolean Equals(IReadOnlyGraphElement<TIdEdge, TRevisionIdEdge, TKeyEdge, TValueEdge> IReadOnlyGraphElement)
        {
