...
namespace de.ahzf.blueprints.InMemoryGraph
{
    ...
    ///                                      \--> inVertex2.
    /// </summary>
    public class HyperEdge : AStringProperties<HyperEdgeId>, IHyperEdge
    {
        ...
        /// </summary>
        protected readonly IEnumerable<IVertex> _InVertices;
        ...
        /// The vertices at the head of this hyperedge.
        /// </summary>
        public IEnumerable<IVertex> InVertices
        {
            get
            {
                return _InVertices;
        ...
        internal protected HyperEdge(IGraph myIGraph, IVertex myOutVertex, IEnumerable<IVertex> myInVertices, HyperEdgeId myHyperEdgeId, String myLabel, Action<IHyperEdge> myHyperEdgeInitializer = null)
            : base(myIGraph, myHyperEdgeId)
        {
        ...
        public override Int32 CompareTo(Object myObject)
        {
            ...
            var myIHyperEdge = myObject as IHyperEdge;
        ...
        ///// <returns>true|false</returns>
        //public Int32 CompareTo(IGenericHyperEdge<IProperties<String>> myIGenericHyperEdgeIPropertiesString)
        //{
        ...
        public override Boolean Equals(Object myObject)
        {
            ...
            var _Object = myObject as IHyperEdge;
            if (_Object != null)
        ...
        /// <param name="myIGenericHyperEdge">An object to compare with.</param>
        /// <returns>true|false</returns>
        public Boolean Equals(IGenericHyperEdge<HyperEdgeId> myIGenericHyperEdge)
        {
