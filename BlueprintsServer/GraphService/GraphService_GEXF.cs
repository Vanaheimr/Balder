...
namespace de.ahzf.Blueprints.HTTP.Server
{
    ...
    /// </summary>
    public class GraphService_GEXF : AGraphService
    {

        #region Constructor(s)

        #region GraphService_GEXF()

        /// <summary>
        /// GEXF content representation.
        /// </summary>
        public GraphService_GEXF()
            : base(HTTPContentType.GEXF_UTF8)
        { }

        #endregion

        #region GraphService_GEXF(IHTTPConnection)

        /// <summary>
        /// GEXF content representation.
        /// </summary>
        /// <param name="IHTTPConnection">The http connection for this request.</param>
        public GraphService_GEXF(IHTTPConnection IHTTPConnection)
