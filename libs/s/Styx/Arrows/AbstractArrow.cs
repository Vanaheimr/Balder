...
namespace de.ahzf.Vanaheimr.Styx
{
    ...
    public abstract class AbstractArrow<TIn, TOut> : IArrow<TIn, TOut>
	{
        ...
        public AbstractArrow(MessageRecipient<TOut> Recipient, params MessageRecipient<TOut>[] Recipients)
        {
            lock (this)
            {
        ...
        /// <param name="Recipient">A recipient of the processed messages.</param>
        /// <param name="Recipients">The recipients of the processed messages.</param>
        public AbstractArrow(IArrowReceiver<TOut> Recipient, params IArrowReceiver<TOut>[] Recipients)
        {
            lock (this)
            {
