...
namespace de.ahzf.Vanaheimr.Styx.Sensors.Active
{
    ...
    public static class IEnumerableExtensions
    {
        ...
        #region ToSensor(this IEnumerable, SensorId, SensorName, ValueUnit)
        ...
        public static ISensor<TId, TValue> ToSensor<TId, TValue>(this IEnumerable<TValue> IEnumerable,
                                                                 TId                      SensorId,
                                                                 String                   SensorName,
                                                                 String                   ValueUnit)
        ...
        {
            return new Sensor<TId, TValue>(IEnumerable, SensorId, SensorName, ValueUnit);
        }

        #endregion


        #region ToActiveSensor(this IEnumerable, SensorId, SensorName, ValueUnit, Autostart, StartAsTask, InitialDelay)
        ...
        public static IActiveSensor<TId, TValue> ToActiveSensor<TId, TValue>(this IEnumerable<TValue> IEnumerable,
                                                                             TId                      SensorId,
                                                                             String                   SensorName,
                                                                             String                   ValueUnit,
        ...
        {
            return new ActiveSensor<TId, TValue>(IEnumerable, SensorId, SensorName, ValueUnit, Autostart, StartAsTask, InitialDelay);
        }

        #endregion

        #region ToActiveSensor(this IEnumerable, SensorId, SensorName, ValueUnit, MessageRecipient.Recipient, Autostart, StartAsTask, InitialDelay)
        ...
        {
            return new ActiveSensor<TId, TValue>(IEnumerable, SensorId, SensorName, ValueUnit, Recipient, Autostart, StartAsTask, InitialDelay);
        }

        #endregion

        #region ToActiveSensor(this IEnumerable, SensorId, SensorName, ValueUnit, IArrowReceiver.Recipient, Autostart, StartAsTask, InitialDelay)
