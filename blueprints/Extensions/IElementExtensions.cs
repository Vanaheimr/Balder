...
//        public static dynamic AsDynamic<TKey>(this IElement<TKey> myIElement)
...
////        public static void SetProperty<TKey>(this IElement<TKey> myIElement, KeyValuePair<TKey, Object> myKeyValuePair)
////            where TKey : IEquatable<TKey>, IComparable<TKey>, IComparable
////        {
//////            return 
...
////        public static void SetProperties<TKey>(this IElement<TKey> myIElement, IEnumerable<KeyValuePair<TKey, Object>> myKeyValuePairs)
////            where TKey : IEquatable<TKey>, IComparable<TKey>, IComparable
////        {
...
////        public static void SetProperties<TKey>(this IElement<TKey> myIElement, IDictionary<TKey, Object> myIDictionary)
////            where TKey : IEquatable<TKey>, IComparable<TKey>, IComparable
////        {
...
//        public static Boolean HasProperty<TKey>(this IElement<TKey> myIElement, TKey myKey)
//            where TKey : IEquatable<TKey>, IComparable<TKey>, IComparable
//        {
...
//        /// <returns>true|false</returns>
//        public static Boolean HasProperty<TKey>(this IElement<TKey> myIElement, TKey myKey, Object myValue)
//            where TKey : IEquatable<TKey>, IComparable<TKey>, IComparable
//        {
...
//        /// <param name="myValue">The property value.</param>
//        /// <returns>true|false</returns>
//        public static Boolean HasProperty<TKey, TValue>(this IElement<TKey> myIElement, TKey myKey, TValue myValue)
//            where TKey : IEquatable<TKey>, IComparable<TKey>, IComparable
//        {
...
//        /// <returns>true|false</returns>
//        public static Boolean HasProperty<TKey>(this IElement<TKey> myIElement, Func<TKey, Object, Boolean> myPropertyFilter = null)
//            where TKey : IEquatable<TKey>, IComparable<TKey>, IComparable
//        {
...
//        /// <param name="myPropertyFilter">A delegate for property filtering.</param>
//        /// <returns>true|false</returns>
//        public static Boolean HasProperty<TKey, TValue>(this IElement<TKey> myIElement, Func<TKey, TValue, Boolean> myPropertyFilter = null)
//            where TKey : IEquatable<TKey>, IComparable<TKey>, IComparable
//        {
...
//        //public static TValue GetProperty<TKey, TValue>(this IElement<TKey> myIElement, TKey myKey)
//        //    where TKey : IEquatable<TKey>, IComparable<TKey>, IComparable
//        //{
...
//        public static IEnumerable<KeyValuePair<TKey, TValue>> GetProperties<TKey, TValue>(this IElement<TKey> myIElement, Func<TKey, TValue, Boolean> myPropertyFilter = null)
//            where TKey : IEquatable<TKey>, IComparable<TKey>, IComparable
//        {
...
//        public static IEnumerable<Object> GetPropertyValues<TKey>(this IElement<TKey> myIElement, Func<TKey, Object, Boolean> myPropertyFilter = null)
//            where TKey : IEquatable<TKey>, IComparable<TKey>, IComparable
//        {
...
//        /// <param name="myPropertyFilter">A delegate for property filtering.</param>
//        /// <returns>An enumeration of all selected property values.</returns>
//        public static IEnumerable<TValue> GetPropertyValues<TKey, TValue>(this IElement<TKey> myIElement, Func<TKey, Object, Boolean> myPropertyFilter = null)
//            where TKey : IEquatable<TKey>, IComparable<TKey>, IComparable
//        {
...
//        public static Boolean CompareProperties<TKey>(this IElement<TKey> myIElement1, IProperties<TKey> myIElement2)
//            where TKey : IEquatable<TKey>, IComparable<TKey>, IComparable
//        {
