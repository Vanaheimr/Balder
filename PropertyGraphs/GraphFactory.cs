...
namespace de.ahzf.Blueprints
{
    ...
    public static class GraphFactory
    {
        ...
        #region CreatePartitionGraph(GraphId, Description = null, GraphInitializer = null)
...

        {
            ...
            return new GenericPartitionPropertyGraph<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                     TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                     TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                     TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>(WriteGraph, ReadGraphs);
