...
namespace de.ahzf.Blueprints.PropertyGraphs.InMemory.Mutable
{
    ...
    public class PropertyVertex<TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,    TPropertiesCollectionVertex,    TVertexCollection,
        ...
        where TVertexCollection              : IPropertyVertex   <TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                                  TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                  TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                                  TIdHyperEdge, TRevisionIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>

        where TEdgeCollection                : IPropertyEdge     <TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                                  TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                  TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                                  TIdHyperEdge, TRevisionIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>

        where TMultiEdgeCollection           : IPropertyMultiEdge<TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                                  TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                  TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                                  TIdHyperEdge, TRevisionIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>

        where THyperEdgeCollection           : IPropertyHyperEdge<TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                                  TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                  TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                                  TIdHyperEdge, TRevisionIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>

    {
        ...
        /// </summary>
        protected readonly IGroupedCollection<TVertexLabel, TIdVertex, TVertexCollection> _Vertices;

        /// <summary>
        /// The edges emanating from, or leaving, this vertex.
        /// </summary>
        protected readonly IGroupedCollection<TEdgeLabel, TIdEdge, TEdgeCollection>     _OutEdges;

        /// <summary>
        /// The edges incoming to, or arriving at, this vertex.
        /// </summary>
        protected readonly IGroupedCollection<TEdgeLabel, TIdEdge, TEdgeCollection> _InEdges;
        ...
        /// </summary>
        protected readonly IGroupedCollection<TEdgeLabel, TIdEdge, TEdgeCollection> _ForeignEdges;

        /// <summary>
        /// The multiedges of this vertex.
        /// </summary>
        protected readonly IGroupedCollection<TMultiEdgeLabel, TIdMultiEdge, TMultiEdgeCollection> _MultiEdges;

        /// <summary>
        /// The hyperedges of this vertex.
        /// </summary>
        protected readonly IGroupedCollection<THyperEdgeLabel, TIdHyperEdge, THyperEdgeCollection> _HyperEdges;
        ...
        internal PropertyVertex(TIdVertex                          VertexId,
                                ...
                                Func<IGroupedCollection<TVertexLabel,    TIdVertex,    TVertexCollection>>    VerticesCollectionInitializer,
                                ...
                                Func<IGroupedCollection<TEdgeLabel,    TIdEdge,    TEdgeCollection>>      EdgesCollectionInitializer,
                                ...
                                Func<IGroupedCollection<TMultiEdgeLabel,    TIdMultiEdge,    TMultiEdgeCollection>> MultiEdgesCollectionInitializer,
                                ...
                                Func<IGroupedCollection<THyperEdgeLabel,    TIdHyperEdge,    THyperEdgeCollection>> HyperEdgesCollectionInitializer)
