...
namespace de.ahzf.Blueprints
{
    ...
    /// <summary>
    /// A rectangle of type Single.
    /// </summary>
    public class RectangleSingle : Rectangle<Single>
    {

        #region Constructor(s)

        #region RectangleSingle(left, top, right, bottom)

        /// <summary>
        /// Create a rectangle of type Single.
        /// </summary>
        /// <param name="left">The left parameter.</param>
        /// <param name="top">The top parameter.</param>
        /// <param name="right">The right parameter.</param>
        /// <param name="bottom">The bottom parameter.</param>
        public RectangleSingle(Single left, Single top, Single right, Single bottom)
        ...
        /// </summary>
        /// <param name="Rectangle1">A Rectangle&lt;Single&gt;.</param>
        /// <param name="Rectangle2">Another Rectangle&lt;Single&gt;.</param>
        /// <returns>true|false</returns>
        public static Boolean operator == (RectangleSingle Rectangle1, RectangleSingle Rectangle2)
        {
