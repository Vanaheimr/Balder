...
namespace de.ahzf.Blueprints.PropertyGraphs
{
    ...
    /// </summary>
    public static class IGenericPropertyEdgeExtensions
    {

        #region AsDynamic(this IGenericPropertyEdge)
        ...
        /// <param name="IGenericPropertyEdge">A generic property edge.</param>
        ...
        {
            return IGenericPropertyEdge as dynamic;
        }

        #endregion


        #region GetProperty(this IGenericPropertyEdge, PropertyKey, OnSuccessAction [Action<TValueEdge>], OnErrorAction)
        ...
        public static void GetProperty<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,    
                           ...
                           (this IGenericPropertyEdge<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,    
                            ...
                            Action<IGenericPropertyEdge<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                        TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,      
                                                        TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
...

        {
            ...
            TValueEdge Value;
            if (IGenericPropertyEdge.TryGetProperty(PropertyKey, out Value))
        ...
        #region GetProperty(this IGenericPropertyEdge, PropertyKey, OnSuccessAction [Action<TKeyEdge, TValueEdge>], OnErrorAction)
        ...
        #region GetKeyValuePair(this IGenericPropertyEdge, PropertyKey, OnSuccessAction [Action<KeyValuePair<TKeyEdge, TValueEdge>>], OnErrorAction)
        ...
        #region GetProperty(this IGenericPropertyEdge, PropertyKey, PropertyType, OnSuccessAction [Action<TValueEdge>], OnErrorAction)
        ...
        #region GetProperty(this IGenericPropertyEdge, PropertyKey, PropertyType, OnSuccessAction [Action<TKeyEdge, TValueEdge>], OnErrorAction)
        ...
        #region GetKeyValuePair(this IGenericPropertyEdge, PropertyKey, PropertyType, OnSuccessAction [Action<KeyValuePair<TKeyEdge, TValueEdge>>], OnErrorAction)
        // Note: Renamed for disambiguity with GetProperty(..., Action<TValueEdge>, ...)
        ...
        #region GetProperty(this IGenericPropertyEdge, PropertyKey, OnSuccessFunc [Func<TValueEdge, Object>], OnErrorFunc)
        ...
        public static Object GetProperty<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                           ...
                           (this IGenericPropertyEdge<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                            ...
                            Func<IGenericPropertyEdge<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                      TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                      TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
        ...
        #region GetProperty(this IGenericPropertyEdge, PropertyKey, OnSuccessFunc [Func<TKeyEdge, TValueEdge, Object>], OnErrorFunc)
        ...
        #region GetKeyValuePair(this IGenericPropertyEdge, PropertyKey, OnSuccessFunc [Func<KeyValuePair<TKeyEdge, TValueEdge>, Object>], OnErrorFunc)
        ...
        #region GetProperty(this IGenericPropertyEdge, PropertyKey, PropertyType, OnSuccessFunc [Func<TValueEdge, Object>], OnErrorFunc)
        ...
        #region GetProperty(this IGenericPropertyEdge, PropertyKey, PropertyType, OnSuccessFunc [Func<TKeyEdge, TValueEdge, Object>], OnErrorFunc)
        ...
        #region GetKeyValuePair(this IGenericPropertyEdge, PropertyKey, PropertyType, OnSuccessFunc [Func<KeyValuePair<TKeyEdge, TValueEdge>, Object>], OnErrorFunc)
        // Note: Renamed for disambiguity with GetProperty(..., Func<TValueEdge, Object>, ...)
