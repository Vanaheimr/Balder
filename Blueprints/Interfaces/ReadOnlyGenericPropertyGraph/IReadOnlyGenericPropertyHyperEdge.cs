...
namespace de.ahzf.Vanaheimr.Blueprints
{
    ...
    #region HyperEdgeAction

    /// <summary>
    /// A delegate for doing something with a read-only generic property hyperedge.
    /// </summary>
    ...
    public delegate void HyperEdgeAction<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
    ...
    #region CheckHyperEdgeExistance
    ...
    /// <param name="HyperEdge">A read-only generic property hyperedge.</param>
    public delegate Boolean CheckHyperEdgeExistance<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                    TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                    TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                    TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>(
    ...
    #region HyperEdgeVertexSelector

    /// <summary>
    /// A delegate for deciding if a vertex matches a hyperedge definition.
    /// </summary>
    /// <typeparam name="TIdVertex">The type of the vertex identifiers.</typeparam>
    /// <typeparam name="TRevIdVertex">The type of the vertex revision identifiers.</typeparam>
    /// <typeparam name="TVertexLabel">The type of the vertex type.</typeparam>
    ...
    /// <typeparam name="TKeyHyperEdge">The type of the hyperedge property keys.</typeparam>
    /// <typeparam name="TValueHyperEdge">The type of the hyperedge property values.</typeparam>
    /// <param name="HyperEdge">A generic read-only property hyperedge.</param>
    /// <returns>True, if the vertex was selected; False otherwise.</returns>
    public delegate Boolean HyperEdgeVertexSelector<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                    TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                    TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                    TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>(
