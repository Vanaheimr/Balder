...
namespace de.ahzf.Blueprints.PropertyGraphs.ReadOnly.Indices
{
    ...
    /// </summary>
    public interface IReadOnlyPropertyElementIndex
    {
    ...
    #region IReadOnlyPropertyElementIndex<T>
    ...
    public interface IReadOnlyPropertyElementIndex<TValue> : IReadOnlyPropertyElementIndex
        where TValue : IEquatable<TValue>, IComparable<TValue>, IComparable
    {
        ...
        IReadOnlyPropertyElementIndex<TKey, TValue> CastTo<TKey>()
    ...
    #region IReadOnlyPropertyElementIndex<TKey, TValue>
    ...
    /// <typeparam name="TKey">The type of the index keys.</typeparam>
    /// <typeparam name="TValue">The type of the elements to be indexed.</typeparam>
    public interface IReadOnlyPropertyElementIndex<TKey, TValue> : IReadOnlyPropertyElementIndex<TValue>
        where TKey   : IEquatable<TKey>,   IComparable<TKey>,   IComparable
        where TValue : IEquatable<TValue>, IComparable<TValue>, IComparable
    {
